...
export const blue = {
  ...
  main: '#2194f3',
  500: '#2194f3',
  600: '#1f87e5', // vs blueDark 900: WCAG 4.6 AAA (large), APCA 36 Not for reading text
  700: '#1a75d2',
  800: '#1764c0',
  900: '#1045a1',
};
    ...
    palette: {
      ...
      ...(mode === 'dark' && {
        background: {
          ...
          paper: blueDark[900],
          header: 'rgba(16, 20, 24, 0.7)',
          primaryMuted: 'rgba(16, 69, 161, 0.4)',
          gradient: `linear-gradient(180deg, ${blueDark[800]} 50%,
          rgba(0, 58, 117, 0.2) 100%)`,
          gradient1: `linear-gradient(180deg, ${blueDark[800]} 50%,
            ${blueDark[900]} 100%)`,
        },
      }),
      ...(mode === 'light' && {
        background: {
          ...
          primaryMuted: 'rgba(33, 148, 243, 0.15)',
          gradient: `linear-gradient(180deg, #fff 50%,
          ${blue[50]} 100%)`,
          gradient1: `linear-gradient(180deg, ${grey[50]} 50%,
            ${grey[100]} 100%)`,
        },
      }),
      common: {
